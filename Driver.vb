...
Public Class Driver
    ...
    Private Sub cmdAdd_Click(sender As Object, e As EventArgs) Handles cmdAdd.Click
        ...
        Dim transaction As OleDbTransaction = ConnMyDB.BeginTransaction()
    ...
    Private Sub cmdDel_Click(sender As Object, e As EventArgs) Handles cmdDel.Click
        Dim transaction As OleDbTransaction = ConnMyDB.BeginTransaction()
        Dim cmd As New OleDbCommand("DELETE FROM RELATION_TRUCK_DRIVER WHERE TRUCK_NO = '" & Truck.txtTruck_No.Text & "' AND DRIVER_NO = '" & SP_DATA(ListMain.Text) & "'", ConnMyDB)
        cmd.Transaction = transaction
        Try
            cmd.ExecuteNonQuery()
            transaction.Commit()
